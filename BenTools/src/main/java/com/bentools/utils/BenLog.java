	...
	public static void debug(String tag, String message) {
		...
		if (mDebug) {
			if (message.length() > maxLength) {
				...
				Log.d(tag, message.substring(maxLength));
			} else {
				Log.d(tag, message);
			}
		}
	...
	public static void error(String tag, String message) {
		...
		if (mError) {
			if (message.length() > maxLength) {
				...
				Log.e(tag, message.substring(maxLength));
			} else {
				Log.e(tag, message);
			}
		}
	...
	public static void info(String tag, String message) {
		...
		if (mInfo) {
			if (message.length() > maxLength) {
				...
				Log.i(tag, message.substring(maxLength));
			} else {
				Log.i(tag, message);
			}
		}
	...
	public static void verbose(String tag, String message) {
		...
		if (mVerbose) {
			if (message.length() > maxLength) {
				...
				Log.v(tag, message.substring(maxLength));
			} else {
				Log.v(tag, message);
			}
		}
	...
	public static void warn(String tag, String message) {
		...
		if (mWarn) {
			if (message.length() > maxLength) {
				...
				Log.w(tag, message.substring(maxLength));
			} else {
				Log.w(tag, message);
			}
		}
